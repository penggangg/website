<template>
  <div class="apphuosedetail" :style="{overflow:shownavigationpops ? 'hidden' : ''}">
     <div class="apphuosedetail-header" :style="{backgroundImage:storeDetails.pic?'url('+ storeDetails.pic[0] +')':''}">
        ...
        <div class="basic-information-mess-items" style="margin-bottom: .05rem;">
         ...
         <div class="basic-information-mess-items" style="margin-top: .05rem;">
           <p>
             ...
             <span style="font-size: .14rem"><b style="font-size: .22rem;color:#F74D3F">{{houseType === 1? `${storeDetails.price}`: `${storeDetails.price/10000}`}}</b>
