        ...
        <div class="basic-information-mess-items" style="margin-bottom: .05rem;">
         ...
         <div class="basic-information-mess-items" style="margin-top: .05rem;">
           <p>
             ...
             <span style="font-size: .12rem"><b style="font-size: .22rem;color:#F74D3F">{{officesDetails.price/10000}}</b><b style="color:#F74D3F">{{houseType === 1? `${item.price}元/月`: `${item.price/10000}万`}}</b></span>
           </p>
         </div>
       </div>
       <div class="basic-information-mess-items">
