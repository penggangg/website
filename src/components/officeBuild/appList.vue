...
<template>
  <div class="newHouselist" :style="{overflow:shownavigationpops ? 'hidden' : 'auto'}">
    ...
    <div class="newHouse-detail-lit">
      <apphuoseList :pagetype="'office'" :listResult="listResult" :count="count" :activePclass="activePclass" @onPullingUp="onPullingUp" :isPullDown="isPullDown"></apphuoseList>
      <!-- <div class="huosefooter">
        <housefooter></housefooter>
      </div> -->
    </div>
     <transition name="fade">
      <filteringpop :arrlist="arrlist" :types="types" :activePclass="activePclass" :filtertop="'1.91rem'" v-model="flitertext" v-show="filteringpopShow" @surefilter="surefilter"></filteringpop>
    </transition>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      flitertext: {}, // 中转站选中的对象
      flitertext1: {key: '', value: '0'}, // 位置选中的对象
      flitertext2: {key: '', value: '0'}, // 价格选中的对象
      query: '' // 关机字
    }
  },
  created () {
